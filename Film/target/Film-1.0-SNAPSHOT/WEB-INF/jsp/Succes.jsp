...
<%
            List<String> description = (List<String>) request.getAttribute("Detail");
%>
<!doctype html>
    ...
    <body class="bg-black text-white mt-0" data-bs-spy="scroll" data-bs-target="#navScroll">
        ...
        <main style="">
            <div class="container">
                ...
                <a class="nav-link fs-5" href="Articles" aria-label="A sample content page">Accueil</a>
                    <small><button class="btn btn-primary" id="pos-paid" type="button" style="background:red;float: right;">PDF</button></small>
              <!--///////////////////////////////-->  
                            ...
                            <div class="row d-flex gx-5 align-items-center">
                                <div class="col-12 col-lg-6">
                                    <div class="rounded-5 bg-black p-5 shadow mt-5" data-aos="zoom-in-left">
                                     <p class="text-secondary"> <%=description.get(i)%></p>
                                        <div class="fs-1">
        ...
        <script>
            ...
            event_object.addEventListener('click', function (e) {
                window.print()
            });
        </script>
        <script>
