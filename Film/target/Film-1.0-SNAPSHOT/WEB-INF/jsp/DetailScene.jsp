<%-- 
    Document   : DetailScene
    Created on : 1 mars 2023, 09:52:01
    Author     : 26132
--%>

<%@page import="com.idealy.articles.model.Personnage"%>
<%@page import="com.idealy.articles.model.Plateau"%>
<%@page import="com.idealy.articles.model.SceneDetail"%>
<%@page import="java.util.List"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%

    List<SceneDetail> scene = (List<SceneDetail>) request.getAttribute("Detail");
    ...
    if (id == null ) {
        System.out.println(request.getAttribute("idScene"));
        id =(request.getAttribute("idScene").toString());
                    ...
                    <div class="col-12 col-lg-10 col-xl-8">
                        <div class="row d-flex align-items-start" data-aos="fade-right">
                            <div class="col-12 col-lg-7">
                                <h2 class="h5 pt-5">Personnage: <%=scene.get(i).getNompersonnage()%></h2>
                                <p class="text-secondary">Humeur:<%=scene.get(i).getHumeur()%></p>
                                <p class="text-secondary">Dialogue: <%=scene.get(i).getText()%></p>
                                <p class="text-secondary">Plateau: <%=scene.get(i).getNomplateau()%></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="AddDetail" method="POST">
                                ...
                                <p> Personnage :
                                    <select name="perso">
                                        ...
                                        <option value="<%=perso.get(i).getIdPersonnage()%>"><%=perso.get(i).getNomPersonnage()%></option>
                                        <% } %>
                                    </select>
                                </p>
                                <p> Plateau :
                                    <select name="plateau">
                                        ...
                                        <option value="<%=plateau.get(i).getIdPlateau()%>"><%=plateau.get(i).getNomPlateau()%></option>
                                        <% }%>
                                    </select>
                                </p>
                                <p>Duree :<input name="duree"></p>
                                <p>Dialogue :<input type="text" name="text"></p>
                                <p>Humeur :<input type="text" name="humeur"></p>
