<%-- 
    Document   : ChoixDate
    Created on : 21 mars 2023, 14:43:52
    Author     : 26132
--%>
...
<%
    ...
    ArrayList<Scene> scene = (ArrayList<Scene>) request.getAttribute("scene");
...
<html>
    ...
    <body class="d-flex h-100 w-100 bg-black text-white" data-bs-spy="scroll" data-bs-target="#navScroll">
        ...
        <div class="h-100 container-fluid">
           ...
           <form class="row"  action="ResultPlaning" method="POST">
            <div class="h-100 row d-flex align-items-stretch">
                        ...
                        <h1>Choix du planning</h1>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control form-control-lg " name="datedebut">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Date fin</label>
                                    <input name="datefin" type="date" class="form-control form-control-lg ">
                                </div>
                ...
                <div class="col-12 col-md-5 col-lg-6 col-xl-7 gradient">
                    ...
                    <div class="row"> 
                        <div style="width: 50%"><%=scene.get(i).getNomScene()%></div>
                        <div style="width: 50%"><input type="checkbox" class="form-check-input" name="liste" value="<%=scene.get(i).getIdscene()%>" /></div>
                    </div>
                    <% }%>
                </div>
