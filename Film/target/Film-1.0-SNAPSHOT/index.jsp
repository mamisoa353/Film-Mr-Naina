...
<html class="h-100" lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="96x96" href="${pageContext.request.contextPath}/resources/img/favicon.png">
        <meta name="author" content="Holger Koenemann">
        <meta name="generator" content="Eleventy v2.0.0">
        <meta name="HandheldFriendly" content="true">
        <title>TP - Mr Naina </title>
                ...
                <div class="container py-vh-4 position-relative mt-5 px-vw-5 text-center">
                    <div class="row d-flex align-items-center justify-content-center py-vh-5">
                        <div class="col-12 col-xl-10">
                            <span class="h5 text-secondary fw-lighter">Nortre mission</span>
                            <h1 class="display-huge mt-3 mb-3 lh-1">Facilite vos Planing de film.</h1>
                        </div>
                        ...
                        <div class="col-12 text-center">
                            <a href="ListeFilms" class="btn btn-xl btn-light">Voir films 
