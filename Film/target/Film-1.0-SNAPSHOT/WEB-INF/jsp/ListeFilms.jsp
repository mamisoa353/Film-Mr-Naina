...
<%
    List<Film> listes = (List<Film>) request.getAttribute("ListesFilms");
%>
<!doctype html>
            ...
            <div class="container">
                ...
                <div class="bg-dark py-vh-5">
                    <div class="container px-vw-5">
                        ...
                        <a href="DetailFilm?id=<%=listes.get(i).getIdFilm()%>"style="color: white;text-decoration: none;">
                            <div class="row d-flex gx-5 align-items-center">
                                <div class="col-12 col-lg-6">
                                    <div class="rounded-5 bg-black p-5 shadow mt-5" data-aos="zoom-in-left">
                                        ...
                                        <p><%=listes.get(i).getResumefilm()%></p>
                                        <div class="d-flex justify-content-start align-items-center border-top pt-3">
                                            <div>
                                                <b><span class="h6 fw-5"> <a href="DetailFilm?id=<%=listes.get(i).getIdFilm()%>"style="color: white;text-decoration: none;"><%=listes.get(i).getNomFilm()%></a></span><br>
